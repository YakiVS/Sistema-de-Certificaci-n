        ...
        <div class="modal-content bd-0">
            ...
            <form method="post" id="cursos_form">
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Mes: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="cur_mes" type="text" name="cur_mes" required />
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Año: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="cur_anio" type="text" name="cur_anio" required />
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
