    ...
    <div class="ht-100v d-flex align-items-center justify-content-center">
        <div class="wd-lg-70p wd-xl-50p tx-center pd-x-40">
            ...
            <div class="form-layout-footer">
                <button class="btn btn-info" id="btnpng"><i class="fa fa-send mg-r-10"></i> Descargar en PNG</button>
                <button class="btn btn-success" id="btnpdf"><i class="fa fa-send mg-r-10"></i> Descargar en PDF</button>
            </div>
        </div>
    </div>
